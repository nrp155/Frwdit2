...
async def run(bot, message):
   ...
   # await m.delete()
    buttons = [[
        InlineKeyboardButton('📜 Support Group', url='https://t.me/trtechguide'),InlineKeyboardButton("✨ Bot Status and More Bots ✨", url="https://t.me/SLBotOfficial/28")
    ],
     ...
     [InlineKeyboardButton("JOIN Chanel", url="https://t.me/DARKEMPIRESL")]
    ] 
    reply_markup = InlineKeyboardMarkup(buttons)
    await m.edit(
